...
*/
$config['tables']['users']           = 'goerp_users';
$config['tables']['groups']          = 'goerp_groups';
$config['tables']['users_groups']    = 'goerp_users_groups';
...
$config['default_group']              = 'customer_service';           // Default group, use name
$config['super_admin_group']          = 'super_admin';
$config['admin_group']                = 'admin';
$config['customer_service_group']     = 'customer_service'; 
