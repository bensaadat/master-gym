...
public function register($identity, $password, $email, $additional_data = array(), $group_ids = array()) //need to test email activation
	...
	public function is_customer_service($id=false){
		$this->ion_auth_model->trigger_events('is_customer_service');
		$customer_service_group = $this->config->item('customer_service_group', 'ion_auth');
		return $this->in_group($customer_service_group, $id);
	}
	...
	public function is_marketing($id=false){
		...
		return $this->in_group($marketing_group, $id);
	}

	public function is_it($id=false){
		$this->ion_auth_model->trigger_events('is_it');
		$it_group = $this->config->item('it_group', 'ion_auth');
		return $this->in_group($it_group, $id);
	}

	public function is_accounting($id=false){
		$this->ion_auth_model->trigger_events('is_accounting');
		$accounting_group = $this->config->item('accounting_group', 'ion_auth');
		return $this->in_group($accounting_group, $id);
	}

	public function is_warehouse($id=false){
		$this->ion_auth_model->trigger_events('is_warehouse');
		$warehouse_group = $this->config->item('warehouse_group', 'ion_auth');
		return $this->in_group($warehouse_group, $id);
	}
